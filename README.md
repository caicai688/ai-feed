...
### 三种筛选方式
1. **信源筛选** - 按特定信源（RSS/YouTube/Twitter）过滤内容
2. **标签筛选** - 按主题标签（AI、OpenAI、Research等）过滤
3. **关键词搜索** - 模糊搜索标题、摘要、标签、信源名称

### 搜索特性
- 🔍 实时搜索，即时显示结果
- 🎯 支持中英文关键词
- 📊 搜索范围：标题、摘要、翻译内容、标签、信源
- 🧹 一键清除所有筛选条件
- 💡 显示筛选状态和结果数量
- 🎨 视觉化的筛选条件标签
...
### 使用示例
- 搜索 "GPT" - 显示所有包含GPT的资讯
- 搜索 "视频" - 显示所有中文翻译中包含"视频"的内容
- 组合使用：选择信源 "OpenAI" + 搜索 "demo" = 只显示OpenAI的演示相关内容
